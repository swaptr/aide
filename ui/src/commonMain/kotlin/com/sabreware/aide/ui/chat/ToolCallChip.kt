...
internal fun toolIconRes(toolName: String): DrawableResource = when (toolName) {
    "CurrentTime" -> Res.drawable.ic_lc_clock
    "Calculator" -> Res.drawable.ic_lc_calculator
    "WebSearch" -> Res.drawable.ic_lc_search
    "WebFetch" -> Res.drawable.ic_lc_globe
    "ListFiles", "FindFiles", "FileInfo", "ReadFile",
    "MakeDir", "MoveFile", "CopyFile", "DeleteFile" -> Res.drawable.ic_lc_folder
    else -> Res.drawable.ic_lc_wrench
}
