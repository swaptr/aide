package com.sabreware.aide.platform.android.text

import android.text.InputType
import android.view.inputmethod.EditorInfo

// Why field text must be withheld; lets consumers decide policy without re-parsing EditorInfo.
// Lives in core/ (platform-port layer) so both the IME and the data layer (SensitiveAudioPolicy) can
// depend on it without a backward data→ime edge.
